...
<head>
    ...
    <title>Admin of resturant</title>
    <!-- BOOTSTRAP STYLES-->
...
float: right;
font-size: 16px;" > <a href="#" style="background-color: #e5b68a;" class="btn btn-success square-btn-adjust">Logout</a> </div>
        </nav>
        <!-- /. NAV TOP  -->
        <nav class="navbar-default navbar-side" role="navigation"  >
            <div class="sidebar-collapse" >
                <ul class="nav" id="main-menu"  style="background-color: #f6f6f6;">
                    ...
                    <li>
                        <a href="meals.php"><i class="fa fa-bars"></i>Meals</a>
                    </li>
                    <li >
